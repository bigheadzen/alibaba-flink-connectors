...
public class DatahubOutputFormat<T> extends RichOutputFormat<T> implements Syncable, HasRetryTimeout {
	...
	public DatahubOutputFormat<T> setRecordResolver(DatahubRecordResolver<T> recordResolver) {
	...
	public static class Builder {
		...
		public Builder setRecordResolver(DatahubRecordResolver recordResolver) {
			this.recordResolver = recordResolver;
			return this;
		}
